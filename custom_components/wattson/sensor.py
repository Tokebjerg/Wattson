...
SENSORS: tuple[WattsonSensorDescription, ...] = (
    ...
    WattsonSensorDescription(
        ...
        attrs_fn=lambda c: {
            ...
            "pv_saturated_samples": len(c._battery_model.pv_rate_samples),
            ...
            "discharge_saturated_samples": len(c._battery_model.discharge_rate_samples),
            "operating_rate_model_version": c._battery_model.operating_rate_model_version,
